...
func _ready() -> void:
	...
	ILLUSTRATIONS = {
		...
		"intrigue_consistoire":  load("res://assets/cards/illustrations/intrigue_consistoire.jpg"),
		"bulle_vendue":          load("res://assets/cards/illustrations/bulle_vendue.jpg"),
		"mascarade_velours":     load("res://assets/cards/illustrations/mascarade_velours.jpg"),
		"appetit_heretique":     load("res://assets/cards/illustrations/appetit_heretique.jpg"),
		"dogme_renverse":        load("res://assets/cards/illustrations/dogme_renverse.jpg"),
		"reliques_menteuses":    load("res://assets/cards/illustrations/reliques_menteuses.jpg"),
		"denonciation_anonyme":  load("res://assets/cards/illustrations/denonciation_anonyme.jpg"),
		"panique_contagieuse":   load("res://assets/cards/illustrations/panique_contagieuse.jpg"),
		"obeissance_pervertie":  load("res://assets/cards/illustrations/obeissance_pervertie.jpg"),
		"renoncement_noir":      load("res://assets/cards/illustrations/renoncement_noir.jpg"),
