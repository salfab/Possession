...
const STRINGS := {
	...
	"ui.rupture.subtitle":   {"fr": "Progression des démons contre le pape.",
		"en": "Demonic progress against the Pope."},
	"ui.rupture.profondeur": {"fr": "Profondeur : %d Infamie(s)\nObjectif : 3, ou Foi/Volonté frappée.",
		"en": "Depth: %d Infamy card(s)\nGoal: 3, or Faith/Will struck."},
	"ui.rupture.etendue":    {"fr": "Étendue : %d/4 Domaines touchés\nObjectif : 4 Domaines transgressés.",
		"en": "Spread: %d/4 Domains touched\nGoal: 4 transgressed Domains."},
	"ui.rupture.ancrage":    {"fr": "Ancrage : %d Domaine(s) scellé(s)\nObjectif : 2, ou Volonté scellée + transgressée.",
		"en": "Anchoring: %d sealed Domain(s)\nGoal: 2, or Will sealed + transgressed."},
	...
	"ui.player_panel.amplify":      {"fr": "Amplifier (%d)", "en": "Amplify (%d)"},
	"ui.player_panel.amplify.tooltip": {"fr": "Amplifier ce Scandale en Infamie (coûte de la Corruption, +1 Ascendant).",
	                                    "en": "Amplify this Scandal into an Infamy (costs Corruption, +1 Ascendancy)."},
	...
	"ui.dialog.title.simonie_pick":     {"fr": "Simonie — Réponse à entraver", "en": "Simony — Response to hinder"},
	"ui.dialog.simonie_pick_prompt":    {"fr": "Choisissez la Réponse liturgique à entraver :", "en": "Choose the Liturgical Response to hinder:"},
	"ui.dialog.simonie_reminder":       {"fr": "%s — Station %s\nIn Integro : %s\nImpedita : %s", "en": "%s — Station %s\nIn Integro: %s\nImpedita: %s"},
