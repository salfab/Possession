...
const STRINGS := {
	...
	"ui.dialog.title.simonie_pick":     {"fr": "Simonie — Station à entraver", "en": "Simony — Station to hinder"},
	"ui.dialog.simonie_pick_prompt":    {"fr": "Choisissez la Station dont la Réponse sera entravée :", "en": "Choose the Station whose Response will be hindered:"},
